    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        switch (id){
            case ID_DETAIL_LOADER:
                ...
                ,null,null,null);
            default:
                throw new RuntimeException("Loader Not Impelmented:" + id);
        }
...
//  TODO (24) Override onLoadFinished
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        double highINCelsuis = data.getDouble(INDEX_WEATHER_MAX_TEMP);
        String highString = SunshineWeatherUtils.formatTemperature(this,highINCelsuis);

        mHighTemperatureView.setText(highString);

        double lowInCelisius = data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String lowString = SunshineWeatherUtils.formatTemperature(this,lowInCelisius);
