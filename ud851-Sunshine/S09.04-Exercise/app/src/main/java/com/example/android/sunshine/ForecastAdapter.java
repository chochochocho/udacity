...
//  TODO (3) Add a Context field to the constructor and store that context in mContext
    ...
    public ForecastAdapterViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.forecast_list_item
        ,viewGroup,false);
...
//      TODO (7) Generate a weather summary with the date, description, high and low
        ...
        double lowInelsius = mCursor.getDouble(MainActivity.INDEX_WEATHER_MIN_TEMP);

        String highAndLowTemperature = SunshineWeatherUtils.formatHighLows(mContext,highInCelsius,lowInelsius);
