...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RESULT_TS_RAN_JSON = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null)
        {
            ...
            String json = savedInstanceState.getString(SEARCH_RESULT_TS_RAN_JSON);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SEARCH_RESULT_TS_RAN_JSON,rawJsonSearchResults);
    }
