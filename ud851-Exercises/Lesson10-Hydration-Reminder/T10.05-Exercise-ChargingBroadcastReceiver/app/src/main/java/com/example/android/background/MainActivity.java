...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChagingFilter = new IntentFilter();
        mChagingFilter.addAction(Intent.ACTION_POWER_CONNECTED);
        mChagingFilter.addAction(Intent.ACTION_POWER_DISCONNECTED);
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mChargingReceiver,mChagingFilter);
    }
